...
export default function DocumentRepository({
  ...
  const [selectedDocumentForPhoto, setSelectedDocumentForPhoto] = useState<Document | null>(null);
  const [isPhotoViewModalOpen, setIsPhotoViewModalOpen] = useState(false);
  const [selectedDocumentForPhotoView, setSelectedDocumentForPhotoView] = useState<Document | null>(null);
    ...
    <main className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-[92px]">
                  ...
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() => {
                            setSelectedDocumentForPhotoView(document);
                        ...
                        <button
                          onClick={() => {
                            setSelectedDocumentForPhoto(document);
      ...
      <PhotoUploadModal
        ...
        onClose={() => {
          ...
          setSelectedDocumentForPhoto(null);
        }}
        documentId={selectedDocumentForPhoto?.id || ''}
        documentName={selectedDocumentForPhoto?.name}
      />
      ...
      <PhotoViewModal
        ...
        onClose={() => {
          setIsPhotoViewModalOpen(false);
          setSelectedDocumentForPhotoView(null);
        }}
        documentId={selectedDocumentForPhotoView?.id || ''}
        documentName={selectedDocumentForPhotoView?.name}
      />
    </main>
  );
}
